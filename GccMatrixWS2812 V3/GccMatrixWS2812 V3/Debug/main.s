...
.Ltext0:
	...
	.section	.text.checkPlayer1Win,"ax",@progbits
.global	checkPlayer1Win
	.type	checkPlayer1Win, @function
checkPlayer1Win:
.LFB75:
	.file 1 "../src/main.c"
	.loc 1 234 0
...
.L__stack_usage = 9
	...
	brne 0b
.LVL0:
	ldi r30,lo8(submarinosJugador2)
	ldi r31,hi8(submarinosJugador2)
	ldi r18,lo8(submarinosJugador2+9)
	ldi r19,hi8(submarinosJugador2+9)
.LBB10:
	.loc 1 239 0
	ldi r25,lo8(1)
.LVL1:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE75:
	.size	checkPlayer1Win, .-checkPlayer1Win
	.section	.text.checkPlayer2Win,"ax",@progbits
.global	checkPlayer2Win
	.type	checkPlayer2Win, @function
checkPlayer2Win:
.LFB76:
	.loc 1 265 0
	.cfi_startproc
...
.L__stack_usage = 9
	...
	brne 0b
.LVL7:
	ldi r30,lo8(submarinosJugador1)
	ldi r31,hi8(submarinosJugador1)
	ldi r18,lo8(submarinosJugador1+9)
	ldi r19,hi8(submarinosJugador1+9)
.LBB12:
	.loc 1 270 0
	ldi r25,lo8(1)
.LVL8:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE76:
	.size	checkPlayer2Win, .-checkPlayer2Win
	.section	.text.delaySeconds,"ax",@progbits
.global	delaySeconds
...
.LFE77:
	...
	.section	.text.copyArrayOf1,"ax",@progbits
.global	copyArrayOf1
	.type	copyArrayOf1, @function
copyArrayOf1:
.LFB78:
	.loc 1 308 0
	.cfi_startproc
...
.L__stack_usage = 2
.LVL22:
	ldi r30,lo8(matrizJugador1)
	ldi r31,hi8(matrizJugador1)
	ldi r22,lo8(display_rgb)
	ldi r23,hi8(display_rgb)
	ldi r28,lo8(matrizJugador1+192)
	ldi r29,hi8(matrizJugador1+192)
	rjmp .L36
.LVL23:
.L37:
.LBB18:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE78:
	.size	copyArrayOf1, .-copyArrayOf1
	.section	.text.copyArrayOf2,"ax",@progbits
.global	copyArrayOf2
	.type	copyArrayOf2, @function
copyArrayOf2:
.LFB79:
	.loc 1 316 0
	.cfi_startproc
...
.L__stack_usage = 2
.LVL27:
	ldi r30,lo8(matrizJugador2)
	ldi r31,hi8(matrizJugador2)
	ldi r22,lo8(display_rgb)
	ldi r23,hi8(display_rgb)
	ldi r28,lo8(matrizJugador2+192)
	ldi r29,hi8(matrizJugador2+192)
	rjmp .L41
.LVL28:
.L42:
.LBB20:
...
/* epilogue start */
	...
	.cfi_endproc
.LFE79:
	.size	copyArrayOf2, .-copyArrayOf2
	.section	.text.scanSubmarinos1,"ax",@progbits
.global	scanSubmarinos1
	.type	scanSubmarinos1, @function
scanSubmarinos1:
.LFB82:
	.loc 1 341 0
	.cfi_startproc
...
.LVL33:
	ldi r30,lo8(submarinosJugador1)
	ldi r31,hi8(submarinosJugador1)
	ldi r28,lo8(submarinosJugador1+9)
	ldi r29,hi8(submarinosJugador1+9)
.LBB22:
	.loc 1 344 0
	mov r20,r24
	lsl r24
...
.LVL34:
	...
	adc r27,r19
	movw r18,r26
	subi r18,lo8(-(matrizJugador1))
	sbci r19,hi8(-(matrizJugador1))
	movw r10,r18
.LVL35:
.L49:
	movw r16,r30
...
.LBE22:
	...
	.cfi_endproc
.LFE82:
	.size	scanSubmarinos1, .-scanSubmarinos1
	.section	.text.scanSubmarinos2,"ax",@progbits
.global	scanSubmarinos2
	.type	scanSubmarinos2, @function
scanSubmarinos2:
.LFB83:
	.loc 1 355 0
	.cfi_startproc
...
.LVL37:
	ldi r30,lo8(submarinosJugador2)
	ldi r31,hi8(submarinosJugador2)
	ldi r28,lo8(submarinosJugador2+9)
	ldi r29,hi8(submarinosJugador2+9)
.LBB23:
	.loc 1 358 0
	mov r20,r24
	lsl r24
...
.LVL38:
	...
	adc r27,r19
	movw r18,r26
	subi r18,lo8(-(matrizJugador2))
	sbci r19,hi8(-(matrizJugador2))
	movw r10,r18
.LVL39:
.L55:
	movw r16,r30
...
.LBE23:
	...
	.cfi_endproc
.LFE83:
	.size	scanSubmarinos2, .-scanSubmarinos2
	.section	.text.scanCargueros1,"ax",@progbits
.global	scanCargueros1
	.type	scanCargueros1, @function
scanCargueros1:
.LFB84:
	.loc 1 369 0
	.cfi_startproc
...
.L__stack_usage = 15
.LVL41:
	ldi r30,lo8(carguerosJugador1)
	ldi r31,hi8(carguerosJugador1)
	mov __tmp_reg__,r31
	ldi r31,lo8(carguerosJugador1+12)
	mov r14,r31
	ldi r31,hi8(carguerosJugador1+12)
	mov r15,r31
	mov r31,__tmp_reg__
.LBB24:
	.loc 1 372 0
	...
	adc r19,r21
	movw r20,r18
	subi r20,lo8(-(matrizJugador1))
	sbci r21,hi8(-(matrizJugador1))
	movw r4,r20
.LVL42:
.L66:
	movw r28,r30
...
.L60:
	...
	adc r21,r29
	movw r28,r20
	subi r28,lo8(-(matrizJugador1))
	sbci r29,hi8(-(matrizJugador1))
	st Y,r6
	std Y+1,r7
	std Y+2,r8
	rjmp .L62
...
.LBE24:
	...
	.cfi_endproc
.LFE84:
	.size	scanCargueros1, .-scanCargueros1
	.section	.text.shootPlayer1,"ax",@progbits
.global	shootPlayer1
	.type	shootPlayer1, @function
shootPlayer1:
.LFB80:
	.loc 1 324 0
	.cfi_startproc
...
.LVL44:
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(matrizJugador1))
	sbci r31,hi8(-(matrizJugador1))
	lds r24,Agua
	lds r25,Agua+1
	lds r26,Agua+2
	st Z,r24
...
.LVL48:
	...
	.cfi_endproc
.LFE80:
	.size	shootPlayer1, .-shootPlayer1
	.section	.text.playPlayer2,"ax",@progbits
.global	playPlayer2
	.type	playPlayer2, @function
playPlayer2:
.LFB74:
	.loc 1 194 0
	.cfi_startproc
...
.LVL49:
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(display_rgb))
	sbci r31,hi8(-(display_rgb))
	lds r24,GamePointer
...
/* epilogue start */
	...
	.cfi_endproc
.LFE74:
	.size	playPlayer2, .-playPlayer2
	.section	.text.scanCargueros2,"ax",@progbits
.global	scanCargueros2
	.type	scanCargueros2, @function
scanCargueros2:
.LFB85:
	.loc 1 400 0
	.cfi_startproc
...
.L__stack_usage = 15
.LVL59:
	ldi r30,lo8(carguerosJugador2)
	ldi r31,hi8(carguerosJugador2)
	mov __tmp_reg__,r31
	ldi r31,lo8(carguerosJugador2+12)
	mov r14,r31
	ldi r31,hi8(carguerosJugador2+12)
	mov r15,r31
	mov r31,__tmp_reg__
.LBB27:
	.loc 1 403 0
	...
	adc r19,r21
	movw r20,r18
	subi r20,lo8(-(matrizJugador2))
	sbci r21,hi8(-(matrizJugador2))
	movw r4,r20
.LVL60:
.L86:
	movw r28,r30
...
.L80:
	...
	adc r21,r29
	movw r28,r20
	subi r28,lo8(-(matrizJugador2))
	sbci r29,hi8(-(matrizJugador2))
	st Y,r6
	std Y+1,r7
	std Y+2,r8
	rjmp .L82
...
.LBE27:
	...
	.cfi_endproc
.LFE85:
	.size	scanCargueros2, .-scanCargueros2
	.section	.text.shootPlayer2,"ax",@progbits
.global	shootPlayer2
	.type	shootPlayer2, @function
shootPlayer2:
.LFB81:
	.loc 1 332 0
	.cfi_startproc
...
.LVL62:
	...
	add r30,r24
	adc r31,r25
	subi r30,lo8(-(matrizJugador2))
	sbci r31,hi8(-(matrizJugador2))
	lds r24,Agua
	lds r25,Agua+1
	lds r26,Agua+2
	st Z,r24
...
.LVL66:
	...
	.cfi_endproc
.LFE81:
	.size	shootPlayer2, .-shootPlayer2
	.section	.text.playPlayer1,"ax",@progbits
.global	playPlayer1
	.type	playPlayer1, @function
playPlayer1:
.LFB73:
	.loc 1 154 0
	.cfi_startproc
...
/* epilogue start */
	...
	.cfi_endproc
.LFE73:
	.size	playPlayer1, .-playPlayer1
	.section	.text.gameOn,"ax",@progbits
.global	gameOn
	.type	gameOn, @function
gameOn:
.LFB72:
	.loc 1 130 0
	.cfi_startproc
...
.LVL85:
	ldi r30,lo8(matrizJugador1)
	ldi r31,hi8(matrizJugador1)
	ldi r20,lo8(matrizJugador1+192)
	ldi r21,hi8(matrizJugador1+192)
	rjmp .L113
.LVL86:
.L114:
.LBB30:
...
.LBE31:
	...
	ldi r30,lo8(matrizJugador2)
	ldi r31,hi8(matrizJugador2)
	ldi r20,lo8(matrizJugador2+192)
	ldi r21,hi8(matrizJugador2+192)
	rjmp .L115
.L113:
.LVL88:
	movw r18,r30
...
.LFE71:
	.size	main, .-main
	.section	.text.clear_disp,"ax",@progbits
.global	clear_disp
	.type	clear_disp, @function
clear_disp:
.LFB86:
	.loc 1 429 0
	.cfi_startproc
...
.L__stack_usage = 0
.LVL95:
	ldi r30,lo8(display_rgb)
	ldi r31,hi8(display_rgb)
	ldi r20,lo8(display_rgb+192)
	ldi r21,hi8(display_rgb+192)
	rjmp .L122
.LVL96:
.L123:
.LBB34:
...
.LFE86:
	...
	.section	.text.softdelay,"ax",@progbits
.global	softdelay
...
/* epilogue start */
	...
	.cfi_endproc
.LFE87:
	.size	softdelay, .-softdelay
.global	msg
	.section	.data.msg,"aw",@progbits
	.type	msg, @object
	.size	msg, 26
msg:
	.string	"Hello from ATmega328p\r\n  "
.global	carguerosJugador2
	.section	.data.carguerosJugador2,"aw",@progbits
	.type	carguerosJugador2, @object
	.size	carguerosJugador2, 12
carguerosJugador2:
	.byte	6
	.byte	6
	.byte	0
	...
	.byte	3
	.byte	0
.global	submarinosJugador2
	.section	.data.submarinosJugador2,"aw",@progbits
	.type	submarinosJugador2, @object
	.size	submarinosJugador2, 9
submarinosJugador2:
	.byte	1
	.byte	6
	.byte	0
	...
	.byte	4
	.byte	0
.global	carguerosJugador1
	.section	.data.carguerosJugador1,"aw",@progbits
	.type	carguerosJugador1, @object
	.size	carguerosJugador1, 12
carguerosJugador1:
	.byte	7
	.byte	7
	.byte	0
	...
	.byte	5
	.byte	0
.global	submarinosJugador1
	.section	.data.submarinosJugador1,"aw",@progbits
	.type	submarinosJugador1, @object
	.size	submarinosJugador1, 9
submarinosJugador1:
	.byte	0
	.byte	3
	.byte	0
	...
	.byte	3
	.byte	0
	.comm	matrizJugador2,192,1
	.comm	matrizJugador1,192,1
	.comm	display_rgb,192,1
.global	Apagado
	.section	.bss.Apagado,"aw",@nobits
	.type	Apagado, @object
	.size	Apagado, 3
Apagado:
	.zero	3
...
.Ldebug_macro0:
	...
	.uleb128 0x2d
	.long	.LASF439
	.file 9 "../src/ASF/common/services/gpio/gpio.h"
	.byte	0x3
	.uleb128 0x38
	.uleb128 0x9
	.byte	0x5
	.uleb128 0x25
	.long	.LASF440
	.file 10 "../src/ASF/common/utils/parts.h"
	.byte	0x3
	.uleb128 0x27
	.uleb128 0xa
	.byte	0x7
	.long	.Ldebug_macro1
	.byte	0x4
	.file 11 "../src/ASF/common/services/gpio/mega_gpio/mega_gpio.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0xb
	.byte	0x5
	.uleb128 0x26
	.long	.LASF702
	.file 12 "../src/ASF/mega/utils/compiler.h"
	.byte	0x3
	.uleb128 0x28
	.uleb128 0xc
	.byte	0x5
	.uleb128 0x25
	.long	.LASF703
	.file 13 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\io.h"
	.byte	0x3
	.uleb128 0x28
	.uleb128 0xd
	.byte	0x5
	.uleb128 0x61
	.long	.LASF704
	.file 14 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\sfr_defs.h"
	.byte	0x3
	.uleb128 0x63
	.uleb128 0xe
	.byte	0x7
	...
	.uleb128 0x23
	.long	.LASF707
	.file 16 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdint.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x10
	.byte	0x3
	...
	.long	.Ldebug_macro5
	.byte	0x4
	.file 17 "C:\\Program Files (x86)\\Atmel\\Studio\\7.0\\Packs\\atmel\\ATmega_DFP\\1.7.374\\include/avr/iom328p.h"
	.byte	0x3
	.uleb128 0x110
	.uleb128 0x11
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 23 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdbool.h"
	.byte	0x3
	.uleb128 0x30
	.uleb128 0x17
	.byte	0x7
	...
	.long	.Ldebug_macro13
	.byte	0x4
	.file 25 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdlib.h"
	.byte	0x3
	.uleb128 0x33
	.uleb128 0x19
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro17
	.file 26 "../src/ASF/common/utils/interrupt.h"
	.byte	0x3
	.uleb128 0x9e
	.uleb128 0x1a
	.byte	0x5
	.uleb128 0x25
	.long	.LASF1829
	.file 27 "../src/ASF/common/utils/interrupt/interrupt_avr8.h"
	.byte	0x3
	.uleb128 0x2a
	.uleb128 0x1b
	.byte	0x5
	...
	.uleb128 0xc
	.byte	0x4
	.file 28 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\interrupt.h"
	.byte	0x3
	.uleb128 0x45
	.uleb128 0x1c
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 29 "../src/ASF/mega/utils/progmem.h"
	.byte	0x3
	.uleb128 0x9f
	.uleb128 0x1d
	.byte	0x5
	.uleb128 0x26
	.long	.LASF1852
	.file 30 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\pgmspace.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0x1e
	.byte	0x7
	...
	.long	.Ldebug_macro23
	.byte	0x4
	.file 31 "../src/ASF/common/services/ioport/ioport.h"
	.byte	0x3
	.uleb128 0x29
	.uleb128 0x1f
	.byte	0x5
	.uleb128 0x26
	.long	.LASF1932
	.file 32 "../src/ASF/common/services/ioport/mega/ioport.h"
	.byte	0x3
	.uleb128 0x7e
	.uleb128 0x20
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 33 "../src/ASF/common/boards/board.h"
	.byte	0x3
	.uleb128 0x3b
	.uleb128 0x21
	.byte	0x7
	.long	.Ldebug_macro26
	.file 34 "../src/ASF/mega/boards/atmega328p_xplained_mini/atmega328p_xplained_mini.h"
	.byte	0x3
	.uleb128 0x16b
	.uleb128 0x22
	.byte	0x5
	.uleb128 0x2a
	.long	.LASF2070
	.file 35 "../src/ASF/mega/boards/atmega328p_xplained_mini/led.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x23
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 36 "../src/ASF/mega/utils/status_codes.h"
	.byte	0x3
	.uleb128 0x45
	.uleb128 0x24
	.byte	0x5
	...
	.byte	0x7
	.long	.Ldebug_macro29
	.file 37 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\util\\delay_basic.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x25
	.byte	0x5
	...
	.long	.LASF2093
	.byte	0x4
	.file 38 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\math.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x26
	.byte	0x7
...
.LASF804:
	.string	"PRIXLEAST8 \"X\""
.LASF2213:
	.string	"carguerosJugador1"
.LASF2215:
	.string	"carguerosJugador2"
.LASF1573:
...
.LASF2129:
	.string	"atan2f atan2"
.LASF2189:
	.string	"scanCargueros1"
.LASF2193:
	.string	"scanCargueros2"
.LASF564:
...
.LASF1956:
	.string	"_BOARD_H_ "
.LASF2172:
	.string	"boolDisparado0"
.LASF2173:
	.string	"boolDisparado1"
.LASF1513:
	.string	"UCPOL0 0"
.LASF1098:
	.string	"GPIOR14 4"
...
.LASF2170:
	.string	"boolDisparado"
.LASF1564:
	.string	"TIMER2_OVF_vect _VECTOR(9)"
.LASF2151:
	.string	"JOYSTICKREADS_H_ "
.LASF2046:
...
.LASF2186:
	.string	"scanSubmarinos1"
.LASF2188:
	.string	"scanSubmarinos2"
.LASF2044:
...
.LASF2212:
	.string	"submarinosJugador1"
.LASF2214:
	.string	"submarinosJugador2"
.LASF1385:
	.string	"OCR1BL0 0"
.LASF690:
